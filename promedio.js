let actividades = [
    {id:1, nombre:'Actividad 1', nota:1},
    {id:2, nombre:'Actividad 1', nota:1.5},
    {id:3, nombre:'Actividad 1', nota:5},
];
let indexActividadSeleccionada = -1;

function mostrarMensaje(promedio){
    let mensaje = promedio>=3?'Felicitaciones aprobó':
...
function mostrarActividades(){
    ...
    document.getElementById('promediosTb')
        ...
        .innerHTML = filas;
    document.getElementById('prodioText')
